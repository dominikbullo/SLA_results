...
competitions_pages = ('http://www.slovak-ski.sk/zjazdove-lyzovanie/podujatia/detail$651.html',
                      'http://www.slovak-ski.sk/zjazdove-lyzovanie/podujatia/detail$652.html',
                      'http://www.slovak-ski.sk/zjazdove-lyzovanie/podujatia/detail$653.html',
                      'http://www.slovak-ski.sk/zjazdove-lyzovanie/podujatia/detail$654.html',
                      'http://www.slovak-ski.sk/zjazdove-lyzovanie/podujatia/detail$655.html',
                      'http://www.slovak-ski.sk/zjazdove-lyzovanie/podujatia/detail$656.html',
                      'http://www.slovak-ski.sk/zjazdove-lyzovanie/podujatia/detail$737.html',
...
def create_results_of_racers_list(data_from, index, percentualna_strata, prva, zucastnil, meno, strata):
    local_column = []
...
def zapis_do_excelu(racers_list_with_results):
    results_of_racers_test = racers_list_with_results
    import xlsxwriter
    start_row = 3  # must be >= 3
    file = "Výsledky AC_UNIZA -- test %s-%s.xlsx" % (datetime.now().year - 1, datetime.now().year)
